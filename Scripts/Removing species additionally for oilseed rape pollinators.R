...
oilseed_rape_species_removal <- NULL
...
# oilseed_rape_species_removal gets oilseed_rape_species_removal that has been grouped by the 
# number of species removed then mean deficits calculated, plus sd and n

oilseed_rape_species_removal <- oilseed_rape_species_removal %>% 
...
ggplot(oilseed_rape_species_removal,
